...
<html lang="en">
   ...
   <!-- body -->
<body>
<form   action="{{ route("fatora.update",["fatora_id"=>fatora_id])}}" method="POST"
...
<div class="mb-3">
    ...
    <input name="tesalsel_edit" type="text"  class="form-control">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">التاريخ</label>
    <input  name="date_edit" type="date"  class="form-control">
  ...
  <div class="mb-3">
    ...
    <input name="subwared_edit" type="text"   class="form-control">
  </div>
