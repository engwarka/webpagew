...
<html lang="en">
   ...
   <!-- body -->
<body>
<form   action="{{route('substore.tasded')}}" method="POST"
...
<div class="mb-3">
    ...
    <input name="madentasded" type="text"  class="form-control">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">التاريخ</label>
    <input  name="datetasded" type="date"  class="form-control">
  ...
  <div class="mb-3">
    ...
    <input name="texttasded" type="text"   class="form-control">
  </div>
