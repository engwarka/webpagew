...
<html lang="en">
   ...
   <!-- body -->
<body>
<form   action="{{ route('substore.fatorahand')}}" method="POST"
...
<div class="mb-3">
    ...
    <input name="tasalsal_hand" type="text"  class="form-control">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">التاريخ</label>
    <input  name="date_subfatorahand" type="date"  class="form-control">
  ...
  <div class="mb-3">
    ...
    <input name="subwaredhand" type="text"   class="form-control">
  </div>
