...
<html lang="en">
   ...
   <!-- body -->
<body>
<form action="{{route('store.fatora')}}" method="POST"
...
<div class="mb-3">
    ...
    <input name="maden" type="text"  class="form-control">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">التاريخ</label>
    <input  name="date_fatora" type="date"  class="form-control">
  ...
  <div class="mb-3">
    ...
    <input name="rased" type="text"   class="form-control">
  </div>
